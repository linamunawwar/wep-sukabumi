								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select class="form-control pegawai" name="nip" required="required">
										...
										@foreach($pegawais as $pegawai)
											<?php $selected = ($pegawai->nip == $alat->nip)? "selected" : ''; ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class='input-group date' id='datepicker' class="datepicker">
						                ...
						                <input type='text' value="{{konversi_tanggal($alat->tanggal_pinjam)}}" name='tanggal_pinjam' class='form-control' required="required" />
						            </div>
								</div>
							</div>
