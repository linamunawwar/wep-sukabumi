					...
					<div class="x_content">
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name='nama_pelatihan' class='form-control' required="required" placeholder="Nama Pelatihan"></textarea>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="penyelenggara" class="form-control" required="required">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">No IM</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="no_im" class="form-control" required="required">
								</div>
							</div>
