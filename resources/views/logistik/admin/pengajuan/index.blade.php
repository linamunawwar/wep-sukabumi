								...
								@foreach ($pengajuans as $pengajuan)
									...
									<tr >
										...
										<td style="text-align:center;">
											...
											<br>
											<a class="btn btn-default btn-xs" title="Edit" style="background-color:#1AAD19; color:#FFFFFF; padding:0.5em 0.7em 0.5em 0.7em;" href="{{url('Logistik/admin/pengajuan/konfirmasi/'.$pengajuan->id.'')}}">Konfirmasi Penyerahan </a>
											@endif           											
										</td>										
									</tr>
								@endforeach						
