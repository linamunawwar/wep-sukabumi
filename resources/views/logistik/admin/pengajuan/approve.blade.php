								...
								<tbody class="data">
                                    ...
                                    @foreach ($details as $detail)
										...
										<tr>
                                            ...
                                            <td><input type="text" name="penyerahanSatuan[]" class="form-control" placeholder="Penyerahan Satuan" required></td>
                                            <td><input type="text" name="penyerahanJumlah[]" class="form-control" placeholder="Penyerahan Jumlah" required></td>
                                        </tr>
                                    <?php $i++; ?>
                                    @endforeach
