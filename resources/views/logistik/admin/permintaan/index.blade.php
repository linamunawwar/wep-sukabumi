						...
						<table id="datatable" class="table table-striped table-bordered">
							...
							<tbody>	
									...
									<td style="text-align:center;">
										...
										<a class="btn btn-default btn-xs" style="background-color:#0984E3; color:#FFFFFF; padding:0.5em 0.7em 0.5em 0.7em;" href="{{url('Logistik/admin/permintaan/download/'.$permintaan->id.'')}}"><i class="fa fa-download" style="font-size:15px;"></i>  </a>
									</td>
									</tr>
								@endforeach							
							</tbody>
