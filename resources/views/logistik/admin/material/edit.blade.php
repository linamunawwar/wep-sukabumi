						...
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="hidden" name="kode_material" id="kode" class='form-control' value="{{$material->kode_material}}"/>
									<input type="text" name="kode_material" id="kode_material" value="{{ $material->kode_material }}" class='form-control' />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="nama" value="{{ $material->nama }}" class='form-control' />									
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name="keterangan" rows="10" cols="100" class="keterangan form-control">{{ $material->keterangan }}</textarea>
								</div>
							</div>
