    ...
    <div class="right_col" role="main">
    	<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Buku Harian Gudang (Log-04) </h2>
									...
									<div class="Laporan">
										<table class="table" style="font-size: 12px;">
										    <tr>
										      <th colspan="4"></th>
										      <th></th>
										      <td style="border: 1px solid #000000;  " colspan="3" align="center">FORM LOGINV-04</td>
										    </tr>
										    <tr>
										      <th></th>
										      <th></th>
										      ...
										      <th></th>
										      <th></th>
										      <td colspan="2" align="center" style="border: 1px solid #000000;">Edisi : Mei 2020 </b></td>
											  <td align="center" style="border: 1px solid #000000;">Revisi : 01 </td>
											 </tr>
										    <tr>
										      <th><img src="../../public/img/Waskita.png" width="50" height="50"></th>
										      <th colspan="3"><b style="font-weight: bold; font-size:16px; ">PT. WASKITA KARYA (Persero) Tbk<br> INDUSTRI KONSTRUKSI</b></th>
										    </tr>
										    <tr>
										    ...
										    <tr>
										        ...
										        <td style="border-top: 1px solid #000000;">Bulan</td>
										        @php
										          $date = explode('-',$dataInput['tanggal_mulai']);
										        @endphp
										        <td colspan="3" style="border-top: 1px solid #000000;">: {{bulan($date[1])}}</td>
										    </tr>
										    <tr>
										        <td></td>
										        <td>Tahun</td>
										    ...
										    <tr class="thead-light" >
										      ...
										      <td style="border: 1px double #000000; font-weight: bold; font-size: 10; width: 10%; height:20;" align="center"> Batch </td>
										    ...
										    <tr>
										        <td colspan="5"></td>
										        <td colspan="2" style="text-align: center;"> Bekasi, {{$dataInput['tanggal_selesai']}} </td>
										    </tr>
										    <tr>
										        <td colspan="5"></td>
										    ...
										    <tr>
										        ...
										        <td colspan="2" style="height:70;"> 
										            @if(file_exists('upload/pegawai/'.$splem->nip.'/'.$splem->ttd))
												        <img src="{{url('upload/pegawai').'/'.$splem->nip.'/'.$splem->ttd}}" width="120" align="center">
												      @endif    
										        </td>
										    </tr>
										    <tr>
