					...
					<div class="x_content">
						<form id="demo-form2" data-parsley-validate  method="POST">
							...
							<table class="table table-bordered permintaan" id="table_permintaan">
								...
								<tbody class="data">   
                                    ...
                                    <tr>                            
										...
										<td> 
											<a href="{{url('Logistik/user/permintaan/deleteDetail/'.$detail->id.'/'.$detail->permintaan_id.'')}}" class="btn btn-sm btn-block btn-danger" style="width:40px;"><span class="fa fa-trash"></span></a> 
										</td>                                           
                                    </tr>					
                                    @endforeach	
								</tbody>
							...
							<div class="form-group" style="margin-left:65em;">
								<div class="col-md-12">
									<a href="{{url('Logistik/user/permintaan/')}}"><button class="btn btn-primary" type="button">Cancel</button></a>									
