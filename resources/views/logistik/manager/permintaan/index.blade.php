								...
								@foreach ($permintaans as $permintaan)
									<tr>
										...
										<td style="color:{{ $permintaan->color }};">
											{{ $permintaan->text }} 
											@if((($permintaan->is_som == '0') || ($permintaan->is_slem == '0') || ($permintaan->is_scarm == '0') || ($permintaan->is_pm == '0')) && (($permintaan->note_som != null) || ($permintaan->note_slem != null) || ($permintaan->note_scarm != null)))
												<br>
