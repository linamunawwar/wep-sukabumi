								...
								@foreach($resigns as $resign)
									<tr>
										...
										<td style="text-align: center;">
											@if(($resign->is_verif_mngr == 1) && ($resign->is_verif_sdm == 1) && ($resign->is_verif_pm == 0))
													<a class="btn btn-success btn-xs" href="{{url('pm/	pegawai/resign/approve/'.$resign->id.'')}}"><i class="fa fa-check" ></i>  Approve</a>
											@else
