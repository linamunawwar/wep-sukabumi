								...
								@foreach($pecats as $pecat)
									<tr>
										...
										<td style="text-align: center;">
											@if(($pecat->is_verif_mngr == 1) && ($pecat->is_verif_sdm == 1) && ($pecat->is_verif_pm == 0))
													<a class="btn btn-success btn-xs" href="{{url('pm/	pegawai/pecat/approve/'.$pecat->id.'')}}"><i class="fa fa-check" ></i>  Approve</a>
											@else
