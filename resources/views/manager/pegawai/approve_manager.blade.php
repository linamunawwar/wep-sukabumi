		                      ...
		                      <div id="step-3">
		                        <h2 class="StepTitle" style="text-align: center;">PERJANJIAN KERJA WAKTU TERTENTU (PKWT)</h2>
			                        ...
			                        <div>
										...
										<ol type="1">
											<li>
												PIHAK PERTAMA akan mempekerjakan PIHAK KEDUA sebagai pekerja PT. WaskitaKarya (Persero) Tbk Proyek Jalan Tol Ciawi Sukabumi Seksi 3, dengan status / kedudukan sebagai pekerja waktu tertentu (tidak tetap) dan ditempatkan sebagai ………………………..
											</li>
											<li>
