...
class PermintaanController extends Controller
{
    ...
    public function beforePostPermintaan()
    {
        ...
        return view('logistik.user.permintaan.create', ['materials' => $materials]);
    }
    ...
    public function getDetailByPermintaanId($id)
    {
        ...
        return view('logistik.user.permintaan.detail', ['details' => $details,'findPermintaan'=>$findPermintaan, 'notifPermintaan' => $notifPermintaan]);
    }
    ...
    public function getPermintaanById($id)
    {
        ...
        return view('logistik.user.permintaan.edit', ['permintaan' => $permintaan, 'detail' => $detailPermintaan, 'materials' => $materials]);
    }
